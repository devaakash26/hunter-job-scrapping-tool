...
export const PLATFORM_COLORS: Record<string, string> = {
  ...
  [PLATFORMS.CARS24]: '#f5b300',
  [PLATFORMS.UNACADEMY]: '#08bd80',
  // High-comp global product companies
  [PLATFORMS.DATABRICKS]: '#ff3621',
  [PLATFORMS.HACKERRANK]: '#00ea64',
  [PLATFORMS.TWILIO]: '#f22f46',
  [PLATFORMS.GITLAB]: '#fc6d26',
  [PLATFORMS.RUBRIK]: '#00b388',
  [PLATFORMS.AIRBNB]: '#ff5a5f',
  [PLATFORMS.COINBASE]: '#0052ff',
  [PLATFORMS.MONGODB]: '#00ed64',
  [PLATFORMS.STRIPE]: '#635bff',
  [PLATFORMS.FIGMA]: '#f24e1e',
  [PLATFORMS.CLOUDFLARE]: '#f38020',
  [PLATFORMS.SCALEAI]: '#5468ff',
  [PLATFORMS.ANTHROPIC]: '#d97757',
  [PLATFORMS.OPENAI]: '#10a37f',
  [PLATFORMS.NOTION]: '#000000',
  // Playwright
